...
import (
	...
	user2 "github.com/anhao26/zero-cloud/service/system/system-rpc/internal/logic/user"
...
func (l *OauthCallbackLogic) OauthCallback(in *system.CallbackReq) (*system.UserInfo, error) {
