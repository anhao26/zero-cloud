module github.com/anhao26/zero-cloud/service/ticket/ticket-api

go 1.20

require (
	github.com/anhao26/zero-cloud/service/ticket/ticket-rpc v0.0.0-20230527175244-d7089045bf0e
