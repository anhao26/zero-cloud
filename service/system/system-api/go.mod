module github.com/anhao26/zero-cloud/service/system/system-api

go 1.20

require (
	github.com/anhao26/zero-cloud/service/system/system-rpc v0.0.0-20230524161145-822ea96d64ab
