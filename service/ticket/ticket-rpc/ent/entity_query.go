...
func (eq *EntityQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (eq *EntityQuery) FirstIDX(ctx context.Context) uint64 {
...
func (eq *EntityQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (eq *EntityQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (eq *EntityQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (eq *EntityQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (eq *EntityQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(entity.Table, entity.Columns, sqlgraph.NewFieldSpec(entity.FieldID, field.TypeUint64))
	_spec.From = eq.sql
